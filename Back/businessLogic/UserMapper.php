...
class UserMapper extends DatabaseConfig {
    ...
    public function insertUser($user){
        $this->query = "insert into users (first_name, last_name, sex, birthday, mobile,email,password,is_admin) values (:firstname, :lastname,:sex,:birthday,:mobile, :email, :password, :is_admin)";
